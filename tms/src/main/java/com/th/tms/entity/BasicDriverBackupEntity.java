...
@Entity
@Table(name = "basic_driver_backup", schema = "thtms", catalog = "")
public class BasicDriverBackupEntity {
    ...
    public boolean equals(Object o) {
        ...
        BasicDriverBackupEntity that = (BasicDriverBackupEntity) o;
