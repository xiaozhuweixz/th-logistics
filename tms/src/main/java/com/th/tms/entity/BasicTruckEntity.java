...
@Entity
@Table(name = "basic_truck", schema = "thtms")
public class BasicTruckEntity {
    ...
    @Basic
    @Column(name = "VIDEO_EQUIPMENT_ID")
    ...
    public boolean equals(Object o) {
        ...
        BasicTruckEntity that = (BasicTruckEntity) o;
        return Objects.equals(truckId, that.truckId) &&
                ...
                Objects.equals(videoEquipmentId, that.videoEquipmentId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(truckId, originalId, carrierId, truckType, truckTonnage, truckLoad, truckLength, truckVolume, truckWidth, truckHeight, truckPhoto, truckBody, truCkInsurance, truckOwner, truckOwnerType, truckDescription, truckState, truckEngine, addName, addDate, updName, comId, comPf, addUserid, uTime, uDelete, truckCode, updDate, truckNum, carrierName, truckFuelType, truckBrand, truckTaxiLicense, truckFrameCode, truckCheck, truckSource, truckEngineCode, videoEquipmentId);
    }
}
