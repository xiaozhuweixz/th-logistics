...
@Entity
@Table(name = "system_user", schema = "thwms", catalog = "")
public class SystemUserEntity {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userId, userName, passwd, rgid, grade, usertype, dispno, isvailid, ipdress, isbindip, islocked, remark, userstat, empId, empName, uDelete, userOrder, comId, addUserid, addTime, addName, updUserid, updTime, updName, uTime);
    }
}
