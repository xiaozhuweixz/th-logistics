...
@Entity
@Table(name = "wms_stock_log", schema = "thwms", catalog = "")
public class WmsStockLogEntity {
    ...
    public boolean equals(Object o) {
        ...
        WmsStockLogEntity that = (WmsStockLogEntity) o;
        return Objects.equals(stockLogId, that.stockLogId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(stockLogId, stockId, ownerId, ownerName, plantId, plantName, areaId, areaName, locId, locName, lotId, billNo, billType, state, goodsId, goodsCode, goodsCnName, goodsEnName, goodsShortName, goodsQuality, goodsGrade, goodsProperty, goodsQuantity, inLocatedNum, outLocatedNum, moveLocatedNum, coDetPlace, coDetProduct, coDetLeave, stockText, addUserid, addTime, addName, updUserid, updTime, updName, uTime);
    }
}
